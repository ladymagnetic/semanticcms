...
// Jonas: das mit den Rollen muss ich nochmal überdenken, aber wahrscheinlich erzeugt es eine neue
	...
	// creats new role by given attributes (booleans)
	//Jonas: kann sein dass das nicht direkt so gebraucht wird, oder bisschen anders --> wird aber saveRolechanges
	...
	// aber der Inhalt der Funktion wird für saveRoleChanges gebraucht, das ist das mit Checkbo
	...
	// Jonas: wird so ähnlich wie defineRole, das muss ich noch ändern
...
// Jonas: das steht noch aus, mussich nochmal überdenken
